  ...
  return (
    <>
      <nav className="fixed   z-20  w-full ">
        <div className=" w-full bg-[#040239] flex px-2 sm:px-6 lg:px-8  ">
          <div className="relative w-full flex h-16 items-center justify-between ">
            <div className="absolute w-full inset-y-0 left-0 flex justify-between  md:hidden ">
              ...
              <div className="">
                {!auth?.user ? (
                  <li className="">
                    {
                      <button className="bg-blue-500    px-4 my-5 tracking-widest py-1 md:py-2 text-lg hover:border-b-2 border-white  font-medium rounded-md text-white">
                        <Link to="/Login">Login</Link>
                      </button>
                    }
                  </li>
                ) : (
                  <div className=" justify-end ml-0">

                    {auth.user.role === "admin" && (
                      <h1>hii i am no admin</h1>
                    )}
                    {auth.user.role === "user" && (
                      <li>
                        <UilUserCircle
            ...
            <div className="flex flex-1 items-center  sm:items-stretch justify-start">
              <div className="hidden md:block   lg:mt-6 md:mt-6  w-full">
                {!auth?.user ? (
                  <div className="flex justify-between  w-full ">
                    ...
                    <div>
                      <ul className="flex space-x-4">
                        ...
                        <li
                          id="home1"
                          className="text-white  hover:bg-[#0f0c5c] hover:text-white rounded-md px-3 py-2 text-lg hover:border-b-2 border-white  font-medium "
                        >
                        ...
                        {/* <li
                          ...
                          className="text-white hover:bg-[#0f0c5c] hover:text-white rounded-md px-3 py-2 text-lg hover:border-b-2 border-white  font-medium"
                        >
                          <Link onClick={toggleMenu} to="/Purchase">
                            Team
                          </Link>
                        </li> */}
                        {/* <button className="text-white hover:bg-[#0f0c5c] hover:text-white rounded-md px-3 py-2 text-lg hover:border-b-2 border-white  font-medium">
        ...
        <div
          className="z-10 relative h-screen duration-500 ease-in-out  md:hidden bg-[#040239]/80   text-center"
          id="mobile_menu"
          style={{ left: "-100%" }}
        >
          {!auth?.user ? (
