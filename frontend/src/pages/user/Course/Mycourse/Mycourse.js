        ...
        <table class="w-full text-left text-sm font-light">
          <thead class="border-2 font-medium dark:border-neutral-500">
            <tr>
              ...
              <th scope="col" class="px-6 py-4">Total Lession</th>
          ...
          <tbody>
            <tr
              ...
              <td class="whitespace-nowrap px-6 py-4">1/50</td>
              <td class="whitespace-nowrap px-6 py-4">@mdo</td>
              <button type='submit' className='w-20 h-8 border-2 bg-slate-700 text-white mt-3 rounded-full'><Link to="/Mycourse/view">view</Link></button>
